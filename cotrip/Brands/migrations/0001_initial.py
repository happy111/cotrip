# Generated by Django 2.1.8 on 2020-03-24 09:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_landing_imge', models.ImageField(blank=True, null=True, upload_to='company_banner', verbose_name='Company Banner')),
                ...
                ('support_person', models.CharField(blank=True, max_length=50, null=True, verbose_name='Support Person Name')),
                ...
                ('auth_user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='company_auth_user', to=settings.AUTH_USER_MODEL)),
